...
curr_df = df[df['stock_name'] == 'Microsoft Corporation (MSFT)'][['Date','Close']]
...
curr_df.index = curr_df.pop('Date')
...
windowed_df = df_to_windowed_df(curr_df,'1987-03-25','2024-02-16',n=3)
print(windowed_df)
...
#plt.plot(curr_df.index, curr_df['Close'])
#plt.show()
